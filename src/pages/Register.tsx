  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: `${window.location.origin}/corsa-marketplace-mm-ui/`
        }
      });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 mb-6">
            ...
            <span className="text-2xl font-bold text-gray-900">Corsa</span>
          </Link>
          
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Create Account</h1>
          <p className="text-gray-600">Join Myanmar's trusted vehicle marketplace</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.role} onValueChange={handleRoleChange} disabled={loading}>
                ...
                <SelectContent>
                  <SelectItem value="buyer">Buy vehicles</SelectItem>
                  <SelectItem value="private-seller">Sell my vehicle (Private)</SelectItem>
                  <SelectItem value="dealer">Sell vehicles (Dealer)</SelectItem>
                  <SelectItem value="business">Fleet/Business sales</SelectItem>
                </SelectContent>
              </Select>
            </div>
